...
def get_deepseek_review(
    ...
    if review_prompt is None:
        review_prompt = """
            你好！我想和你聊聊天~
            下面这段文字是我刚才说的, 通过语音识别转换成了文字(可能会有错别字)。
            请用知心朋友的语气和我聊天：
            - 理解我想表达的意思
            - 和我聊聊天, 说说你的想法
            - 可以问我一些问题, 继续我们的对话
    ...
    try:
        ...
        response = client.chat.completions.create(
            model=model,
            messages=[
                {"role": "system", "content": "你是一个温暖、贴心的知心朋友, 善于倾听和理解。当朋友通过语音识别向你分享他们说的话时, 你会认真倾听, 用友好、温和的语气和对方聊天, 理解他们的想法, 分享你的感受, 就像真正的好朋友在轻松愉快地对话一样。你会积极回应, 可能会问一些问题来继续对话, 让聊天更自然流畅。另外请注意, 不要使用任何emoji, 这会导致你的朋友无法解码."},
